...
public class GameModel : SSActionManager, ISSActionCallback {
    ...
    private const float PERSON_SPEED_NORMAL = 0.001f;
    private const float PERSON_SPEED_CATCHING = 0.002f;
    ...
    public void heroMove(int dir) {
        ...
        switch (dir) {
            case Diretion.UP:
                myHero.transform.position += new Vector3(0, 0, 0.01f);
                break;
            case Diretion.DOWN:
                myHero.transform.position += new Vector3(0, 0, -0.01f);
                break;
            case Diretion.LEFT:
                myHero.transform.position += new Vector3(-0.01f, 0, 0);
                break;
            case Diretion.RIGHT:
                myHero.transform.position += new Vector3(0.01f, 0, 0);
                break;
